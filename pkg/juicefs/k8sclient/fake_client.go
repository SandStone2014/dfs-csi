...
func (f *FakeK8sClient) GetAllPod() (*corev1.PodList, error) {
	return &corev1.PodList{}, nil
}

func (f *FakeK8sClient) GetPersistentVolume(pvName string) (*corev1.PersistentVolume, error) {
	return nil, nil
}
...
func (f *FakeK8sClient) PatchPod(ctx context.Context, pod *corev1.Pod, data []byte, pt types.PatchType) error {
	if pod == nil {
...
func (f *FakeK8sClient) GetPodLog(ctx context.Context, podName, namespace, containerName string) (string, error) {
	return "", nil
}
